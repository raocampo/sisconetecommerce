...
<div class="jd-slider">
    ...
    <div class="slide-inner">
        ...
        <ul class="slide-area">
            ...
            <li>
                <img src="<?php echo $path ?>views/assets/img/carrusel/1/back_default.jpg" alt="img-fluid">

                <div class="slideOpt opt1">

                    <img src="<?php echo $path ?>views/assets/img/carrusel/1/calzado.png" style="top:15%; right:10%; width:45%">

                    <div class="slideText" style="top: 20%; left:10%; width:45%;">
            ...
            <li>
                <img src="<?php echo $path ?>views/assets/img/carrusel/2/fondo2.jpg" alt="img-fluid">

                <div class="slideOpt opt2">

                    <img src="<?php echo $path ?>views/assets/img/carrusel/2/iphone.png" style="bottom:0%; left:15%; width:28%">
            ...
            <li>
                <img src="<?php echo $path ?>views/assets/img/carrusel/3/fondo3.jpg" alt="img-fluid">
            </li>

           <!-- <li>
                <img src="<?php echo $path ?>views/assets/img/carrusel/1/calzado.png" alt="img-fluid">
            </li>-->
