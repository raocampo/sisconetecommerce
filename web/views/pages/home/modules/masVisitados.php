<div class="container-fluid bg-light border">
    ...
    <div class="container clearfix">
        ...
        <div class="btn-group float-end p-2">
            ...
            <button class="btn btn-default btnView bg-blue" attr-type="grid" attr-index="2">

                <i class="fas fa-th fa-xs pe-1"></i>

                <span class="col-xs-0 float-end small mt-1">CUADROS</span>
...
<div class="container-fluid bg-white">
    ...
    <div class="container">
        ...
        <div class="clearfix pt-3 pb-0 px-2">
            ...
            <h4 class="float-start text-uppercase pt-2">Articulos Mas Vistos</h4>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 pt-3 pb-4 grid-2">
            ...
            <div class="col px-3 py-0 py-lg-0">

                <a href="#">

                    <figure class="imgProduct">

                        <img class="img-fluid" src="<?php echo $path ?>views/assets/img/productos/Componentes/kit1.webp" alt="">
                ...
                <div class="clearfix">
                    ...
                    <h5 class="float-start text-uppercase text-muted">
                        <del class="small" style="color:#bbb">USD $29,00</del> $11,00
                    </h5>
            ...
            <div class="col px-3 py-0 py-lg-0">
                ...
                <a href="#">
                    ...
                    <figure class="imgProduct">
                        ...
                        <img class="img-fluid" src="<?php echo $path ?>views/assets/img/productos/Componentes/varios.webp" alt="">
            ...
            <div class="col px-3 py-0 py-lg-0">
                ...
                <a href="#">
                    ...
                    <figure class="imgProduct">
                        ...
                        <img class="img-fluid" src="<?php echo $path ?>views/assets/img/productos/Componentes/video.webp" alt="">

                    </figure>

                    <h5><small class="text-uppercase text-muted">Tarjeta Video</small></h5>
            ...
            <div class="col px-3 py-0 py-lg-0">
                ...
                <a href="#">
                    ...
                    <figure class="imgProduct">
                        ...
                        <img class="img-fluid" src="<?php echo $path ?>views/assets/img/productos/Componentes/monitor.webp" alt="">
        ...
        <div class="row list-2" style="display:none">
            ...
            <div class="media border-bottom px-3 pt-4 pb-3 pb-lg-2 ">
                ...
                <figure class="imgProduct">
                    ...
                    <img class="img-fluid" src="<?php echo $path ?>views/assets/img/productos/Componentes/kit1.webp" style="width: 150px" alt="">
            ...
            <div class="media border-bottom px-3 pt-4 pb-3 pb-lg-2 ">
                ...
                <figure class="imgProduct">
                    ...
                    <img class="img-fluid" src="<?php echo $path ?>views/assets/img/productos/Componentes/varios.webp" style="width: 150px" alt="">
            ...
            <div class="media border-bottom px-3 pt-4 pb-3 pb-lg-2 ">
                ...
                <figure class="imgProduct">
                    ...
                    <img class="img-fluid" src="<?php echo $path ?>views/assets/img/productos/Componentes/video.webp" style="width: 150px" alt="">
            ...
            <div class="media border-bottom px-3 pt-4 pb-3 pb-lg-2 ">
                ...
                <figure class="imgProduct">
                    ...
                    <img class="img-fluid" src="<?php echo $path ?>views/assets/img/productos/Componentes/monitor.webp" style="width: 150px" alt="">
